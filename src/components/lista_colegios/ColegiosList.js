...
const ColegioList = () => {
    ...
    const handleDelete = (id) => {
        // Realizar la eliminación en el backend y actualizar la lista de colegios
        axios.delete(`http://localhost:8081/api/v1/colegios/delete/${id}`)
            .then(() => {
                fetchColegios();
            })
    ...
    const handleFormSubmit = (e) => {
        ...
        if (isEditing) {
            // Editar colegio
            axios.put(`http://localhost:8081/api/v1/colegios/update`, newColegio)
                .then(() => {
                    fetchColegios();
                    closeModal();
                })
            ...
            // Añadir colegio
            axios.post('http://localhost:8081/api/v1/colegios/save', newColegio)
                .then(() => {
                    fetchColegios();
                    closeModal();
                })
